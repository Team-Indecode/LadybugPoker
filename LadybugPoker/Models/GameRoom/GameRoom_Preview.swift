...
extension GameRoom {
    ...
    static var listPreview: GameRooms {
        [
            GameRoom(id: "testId1", hostId: "test", title: "고수만 오세요", password: nil, maxUserCount: 6, code: "A2F5E2", users: ["123", "234", "345", "456"], usersInGame: [UserInGame(readyOrNot: true, handCard: [Card(bug: .bee, cardCnt: 1), Card(bug: .frog, cardCnt: 2), Card(bug: .rat, cardCnt: 1)], boardCard: [Card(bug: .bee, cardCnt: 1), Card(bug: .ladybug, cardCnt: 2), Card(bug: .snake, cardCnt: 2)], userId: "123")], whoseTurn: "", whoseGetting: "", selectedCard: .bee, turnStartTime: .now),
